...
export default function HeroSection() {
  return (
    <section className="w-full min-h-[70vh] flex flex-col md:flex-row items-center justify-between bg-white overflow-hidden">
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center relative h-[320px] md:h-[600px]">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          ...
          {/* Mobile shape */}
          <div className="block md:hidden w-[320px] h-[220px] bg-green rounded-[50%]" />
        </div>
        {/* Actual product/fruit image */}
        <div className="relative z-10 flex items-center justify-center w-[220px] h-[220px] md:w-[420px] md:h-[420px]">
          <Image
